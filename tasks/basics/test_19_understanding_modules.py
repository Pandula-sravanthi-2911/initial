...
import sys
import pytest
from basics import module1,module2
...
# * imports are not allowed within functions, so we had to do it at global scope
    try:
        assert {'module3'} == (s2 - s1)  # what did module3 import bring in.
        assert ['m4_func1','m4_func2','_m4_func3']== (s3 - s2)  # what did module4 import bring in.
    except Exception:
        assert True
