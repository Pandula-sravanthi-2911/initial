...
def test_function_call_without_except():
    ...
    try:
        ...
        result.append("m:except")
    assert ["m:beforecall","f:enter","f:return","m:aftercall"] == result
...
def test_else_on_no_exception():
    ...
    assert ["m:beforecall","f:enter","f:return","m:aftercall","m:else"] == result
...
def test_finally_on_no_exception():
    ...
    assert ["m:beforecall","f:enter","f:return","m:aftercall","m:else","m:finally"] == result
